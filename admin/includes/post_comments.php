<table class="table table-bordered table-hover">
                              ...
                              <tbody>
                                 <?php
                                   ...
                                   $query .= mysqli_real_escape_string($connection,$_GET['p_id']) ;
                                   ...
                                   while($row = mysqli_fetch_assoc($select_comments_admin)) {
                                    ...
                                    echo "<td><a href='?source=post_comments&p_id={$_GET['p_id']}&approve={$comment_id}'>Approve</a></td>";      
           
                                    // echo "<td><a href='comments.php?approve={$comment_id}'>Approve</a></td>"; 
                                       
                                     echo "<td><a href='?source=post_comments&p_id={$_GET['p_id']}&unapprove={$comment_id}'>Unapprove</a></td>"; 
                                       
                                     echo "<td><a href='?source=post_comments&p_id={$_GET['p_id']}&delete=$comment_id'>delete</a></td>";
                         ...
                         <?php
                            ...
                            if(isset($_GET['delete'])) {
                                ...
                                header("Location: ?source=post_comments&p_id={$_GET['p_id']}");
                            }
